...
public class RegistrarClienteForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtNombres.setBounds(130, 150, 71, 26);
        getContentPane().add(txtApellidoP);
        txtApellidoP.setBounds(130, 180, 71, 26);
        getContentPane().add(txtApellidoM);
        txtApellidoM.setBounds(130, 210, 71, 26);
        ...
        txtCalle.setBounds(340, 150, 83, 26);
        getContentPane().add(txtCodigoPostal);
        txtCodigoPostal.setBounds(340, 180, 70, 26);
        getContentPane().add(txtNumExt);
        txtNumExt.setBounds(340, 210, 35, 26);
        ...
        btnAceptar.setBounds(300, 260, 90, 27);

        lblContrasenia.setText("Contraseña:");
        getContentPane().add(lblContrasenia);
        lblContrasenia.setBounds(120, 170, 70, 16);
        getContentPane().add(txtContrasenia);
        txtContrasenia.setBounds(190, 170, 90, 26);
        ...
        comboBoxAnio.setBounds(40, 270, 70, 26);
        ...
        comboBoxMes.setBounds(110, 270, 76, 26);
        ...
        comboBoxDia.setBounds(180, 270, 76, 26);
        ...
        btnVolver.setBounds(340, 40, 76, 27);
